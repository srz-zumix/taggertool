...
#        self.assertEqual(DictResult.Abbreviation, abbreviation_glosbe.check_suspicion('pea'))
    ...
    def test_yay(self):
        self.assertNotEqual(DictResult.Found, abbreviation_glosbe.check_suspicion('yay'))
    ...
    def test_sal(self):
        self.assertNotEqual(DictResult.Found, abbreviation_glosbe.check_suspicion('sal'))
